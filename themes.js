var themes = {
  'trees': {
    'subjects': [
      ['elm', 'pines', 'trees', 'larch', 'groves'],
      ['maple', 'sapling', 'olive', 'tree ring', 'cherry', 'forests', 'dryads', 'eden', 'garden'],
      ['sycamore']
    ],
    'nouns': [
    ...
    'adjectives': [
      ['old', 'grave', 'dead', 'dank', 'vast'],
      ['ancient', 'gnarled', 'cracked', 'weathered', 'scaly', 'sashed', 'wanton', 'smokey', 'staggered', 'in bloom'],
      ['hardened', 'matronly']
    ],
    'adverbs': [
      ['here', 'there'],
  ...
  'mammals': {
    ...
    'colors': [
      ['black', 'brown', 'jet', 'grey', 'brick'],
      ['golden', 'concrete', 'sanguine', 'granite', 'shadow', 'tabby']
    ],
    'functions': [
  ...
  'fish': {
    ...
    'adjectives': [
      ...
      ['briny', 'robust', 'timid', 'quiet', 'scaly', 'hungry', 'soggy', 'icy'],
